...
class ViewMerchant extends Component {
	...
	componentDidMount() {
		...
		this.fetchData(`https://www.paylinkup.online/viewclient?company_name=${company_name}`,
			(data) => {
				this.setState({
					idforEdit: data._id,
	...
	handleSave = () => {
		...
		fetch(`https://www.paylinkup.online/updateratetable`, {
			...
			.then((data) => {
				...
				this.setState({
					ratesData: data.rates, isEditing: false, errorMessage: "Data Edited Successfully.",
					messageType: "success",
				});
