...
//SVG Icons
import { Search, Oops, DownSign, UpSign } from "../../media/icon/SVGicons";
...
class TransactionMonitoring extends Component {
	...
	handleQuickSearch = (buttonName) => {
		...
		if (buttonName === "Today") {
			...
			console.log("to", to);
			this.setState({ fromDate: from, toDate: to, activeQuickSearchbtn: buttonName });
	...
	render() {
		const { headerLabels, searchedResult, activeQuickSearchbtn, selectedRowToView, userRole } = this.state;
		if(userRole === "admin" || "employee"){
			if (!selectedRowToView) {
									...
									<div className="row-cards search-card">
										<div className="id-search-row">
											<div className="id-input-div">
												<label className={`id-label ${this.state.searchIds ? "filled-id-label" : ""} `} htmlFor="searchIds">
													Id:
												</label>
												<input
													className="id-input"
											...
											<div className="search-select-div">
												<label className={`id-label ${this.state.status ? "filled-id-label" : ""} `} htmlFor="status">
													Status:
												</label>
												<select
													className="id-input"
										...
										<div className="from-to-input-div">
											<div className="date-input-div">
												<label className={`date-label ${this.state.fromDate ? "filled-id-label" : ""} `} htmlFor="fromDate">
													From:
												</label>
												<input
											...
											<div className="date-input-div">
												<label className={`date-label ${this.state.toDate ? "filled-id-label" : ""} `} htmlFor="toDate">
													To:
												</label>
												<input
													className="date-input"
										...
										<div className="quick-search-div">
											<div>
												...
												<div>
													{activeQuickSearchbtn === "Today" ? <button
													...
													{activeQuickSearchbtn === "Yesterday" ? <button
														className='active-quick-search-btn'
													...
													{activeQuickSearchbtn === "This Week" ? <button
														className='active-quick-search-btn'
													...
													{activeQuickSearchbtn === "Last Week" ? <button
														className='active-quick-search-btn'
													...
													{activeQuickSearchbtn === "This Month" ? <button
														className='active-quick-search-btn'
													...
													{activeQuickSearchbtn === "Last Month" ? <button
														className='active-quick-search-btn'
													...
													{activeQuickSearchbtn === "This Year" ? <button
														className='active-quick-search-btn'
										...
										<div className="more-options-div">
											...
											<label className={`id-label ${this.state.country ? "filled-id-label" : ""} `} htmlFor="country">
												Country:
											</label>
											<select
												className="id-input"
											...
											<label className={`id-label ${this.state.cardtype ? "filled-id-label" : ""} `} htmlFor="cardtype">
												Card Type:
											</label>
											<select
												className="id-input"
											...
											<label className={`id-label ${this.state.cardnumber ? "filled-id-label" : ""} `} htmlFor="cardnumber">
												Card Number:
											</label>
											<input
												className="id-input"
								...
								{this.state.searchedResult === null ? (
									<div className="row-cards search-result">
										<div className="search-result-head">
											<div>
												<h4>Search</h4> <Search className="primary-color-icon" />
											</div>
				...
				return (
					<ViewTransaction data={selectedRowToView} onViewClick={this.handleViewClick} />
				);
			}
